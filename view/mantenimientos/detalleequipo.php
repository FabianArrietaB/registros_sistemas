<!-- Formulario (Editar) -->
    <div class="modal fade" id="detalleequi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <div class="input-group mb-3">
                                    ...
                                    <input disabled type="text" id="marcau" name="marcau" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="input-group mb-3">
                            ...
                            <div class="col-4">
                                <div class="input-group mb-3">
                                    ...
                                    <input disabled type="text" id="areau" name="areau" class="form-control input-sm">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="inputGroup-sizing-default">Tipo Ram</span>
                                    <input disabled type="text" id="tipramu" name="tipramu" class="form-control input-sm">
                                </div>
                            </div>
                            <div class="col-3">
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="inputGroup-sizing-default">Ram</span>
                                    <input disabled type="text" id="ramu" name="ramu" class="form-control input-sm">
                                </div>
                            </div>
                            <div class="col-5">
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="inputGroup-sizing-default">Procesador</span>
                                    <input disabled type="text" id="procesau" name="procesau" class="form-control input-sm">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="inputGroup-sizing-default">Tipo Disco</span>
                                    <input disabled type="text" id="tipdisu" name="tipdisu" class="form-control input-sm">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="inputGroup-sizing-default">Capacidad</span>
                                    <input disabled type="text" id="capdisu" name="capdisu" class="form-control input-sm">
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="input-group mb-3">
                                    <span class="input-group-text" id="inputGroup-sizing-default">Registro</span>
                                    <input disabled type="text" id="fechau" name="fechau" class="form-control input-sm">
                                </div>
                            </div>
                        </div>
                    </fieldset>
